...
class RiderDraggableWidget extends StatelessWidget {
  const RiderDraggableWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return DraggableScrollableSheet(
        ...
        builder: (BuildContext context, myscrollController) {
          return Container(
            decoration: BoxDecoration(color: StyleApp.white,
//                        borderRadius: BorderRadius.only(
//                            topLeft: Radius.circular(20),
//                            topRight: Radius.circular(20)),
                boxShadow: [
                  BoxShadow(
                      color: StyleApp.grey.withOpacity(.8),
                ...
                ListTile(
                  ...
                  title: Row(
                    ...
                    children: [
                      ...
                      ], style: TextStyle(color: StyleApp.black))),
                    ],
                  ),
                  trailing: Container(
